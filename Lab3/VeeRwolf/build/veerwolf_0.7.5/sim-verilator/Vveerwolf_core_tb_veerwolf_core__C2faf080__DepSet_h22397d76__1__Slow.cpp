...
VL_ATTR_COLD void Vveerwolf_core_tb_veerwolf_core__C2faf080___stl_sequent__TOP__veerwolf_core_tb__veerwolf__4(Vveerwolf_core_tb_veerwolf_core__C2faf080* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vveerwolf_core_tb_veerwolf_core__C2faf080___stl_sequent__TOP__veerwolf_core_tb__veerwolf__4\n"); );
    // Body
    ...
    if (vlSymsp->TOP__veerwolf_core_tb.__PVT__dmi_reg_en) {
        vlSelf->rvtop__DOT__veer__DOT__dbg__DOT____VdfgTmp_h47440a99__0 
            = vlSymsp->TOP__veerwolf_core_tb.__PVT__dmi_wrapper__DOT__i_dmi_jtag_to_core_sync__DOT__c_wr_en;
