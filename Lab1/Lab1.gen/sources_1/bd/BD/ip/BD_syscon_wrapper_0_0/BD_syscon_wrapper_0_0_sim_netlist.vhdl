...
--               /home/gost/Desktop/Repositories/RVfpgaSoC-Labs/Lab1/Lab1.gen/sources_1/bd/BD/ip/BD_syscon_wrapper_0_0/BD_syscon_wrapper_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of BD_syscon_wrapper_0_0_swervolf_syscon is
  ...
  signal \o_nmi_vec[31]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of irq_gpio_enable_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of irq_ptc_enable_i_2 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \irq_timer_cnt[31]_i_5\ : label is "soft_lutpair5";
  attribute ADDER_THRESHOLD of \mtime_reg[0]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[12]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[16]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[20]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[24]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[28]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[32]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[36]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[40]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[44]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[48]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[4]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[52]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[56]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[60]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \mtime_reg[8]_i_1\ : label is 35;
  attribute SOFT_HLUTNM of \mtimecmp[63]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of nmi_int_i_9 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_nmi_vec[31]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of o_wb_ack_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \o_wb_rdt[31]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \o_wb_rdt[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_wb_rdt[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_wb_rdt[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of sw_irq3_i_5 : label is "soft_lutpair2";
begin
...
\irq_timer_cnt[23]_i_2\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => i_wb_sel(2),
      I2 => \irq_timer_cnt[31]_i_4_n_0\,
      I3 => \irq_timer_cnt0__60\(23),
      O => p_1_in(23)
    );
\irq_timer_cnt[24]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
      ...
      I1 => i_wb_sel(3),
      I2 => \irq_timer_cnt[31]_i_4_n_0\,
      I3 => \irq_timer_cnt0__60\(24),
      O => p_1_in(24)
    );
\irq_timer_cnt[25]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
      ...
      I1 => i_wb_sel(3),
      I2 => \irq_timer_cnt[31]_i_4_n_0\,
      I3 => \irq_timer_cnt0__60\(25),
      O => p_1_in(25)
    );
\irq_timer_cnt[26]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
      ...
      I1 => i_wb_sel(3),
      I2 => \irq_timer_cnt[31]_i_4_n_0\,
      I3 => \irq_timer_cnt0__60\(26),
      O => p_1_in(26)
    );
\irq_timer_cnt[27]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
      ...
      I1 => i_wb_sel(3),
      I2 => \irq_timer_cnt[31]_i_4_n_0\,
      I3 => \irq_timer_cnt0__60\(27),
      O => p_1_in(27)
    );
\irq_timer_cnt[28]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
      ...
      I1 => i_wb_sel(3),
      I2 => \irq_timer_cnt[31]_i_4_n_0\,
      I3 => \irq_timer_cnt0__60\(28),
      O => p_1_in(28)
    );
\irq_timer_cnt[29]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
...
\irq_timer_cnt[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => i_wb_sel(0),
      I2 => \irq_timer_cnt[31]_i_4_n_0\,
      I3 => \irq_timer_cnt0__60\(2),
      O => p_1_in(2)
    );
\irq_timer_cnt[30]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
...
\irq_timer_cnt[31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
...
\irq_timer_cnt[31]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => i_wb_adr(3),
      I3 => i_wb_adr(0),
      I4 => \irq_timer_cnt[31]_i_5_n_0\,
      I5 => \^o_wb_ack_reg_1\,
      O => \irq_timer_cnt[31]_i_3_n_0\
    );
\irq_timer_cnt[31]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
\mtimecmp[63]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
nmi_int_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \irq_timer_cnt_reg_n_0_[28]\,
      I1 => \irq_timer_cnt_reg_n_0_[13]\,
      I2 => \irq_timer_cnt_reg_n_0_[27]\,
...
nmi_int_i_7: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \irq_timer_cnt_reg_n_0_[29]\,
      I3 => \irq_timer_cnt_reg_n_0_[1]\,
      O => nmi_int_i_7_n_0
    );
...
\o_wb_rdt[25]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \irq_timer_cnt_reg_n_0_[25]\,
      I4 => \o_wb_rdt[31]_i_4_n_0\,
      I5 => \o_wb_rdt[25]_i_3_n_0\,
...
sw_irq3_i_3: unisim.vcomponents.LUT6
    generic map(
...
sw_irq3_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of BD_syscon_wrapper_0_0_syscon_wrapper is
  ...
  signal syscon_n_76 : STD_LOGIC;
  signal syscon_n_77 : STD_LOGIC;
  signal syscon_n_78 : STD_LOGIC;
  signal syscon_n_8 : STD_LOGIC;
  signal syscon_n_80 : STD_LOGIC;
  signal syscon_n_81 : STD_LOGIC;
  signal syscon_n_82 : STD_LOGIC;
  signal syscon_n_83 : STD_LOGIC;
  signal syscon_n_84 : STD_LOGIC;
begin
...
syscon: entity work.BD_syscon_wrapper_0_0_swervolf_syscon
     port map (
      gpio_irq => gpio_irq,
      gpio_irq_0 => syscon_n_81,
      i_clk => i_clk,
      i_ram_init_done => i_ram_init_done,
      i_ram_init_error => i_ram_init_error,
      i_rst => i_rst,
      i_wb_adr(3 downto 0) => i_wb_adr(3 downto 0),
      i_wb_adr_2_sp_1 => syscon_n_80,
      i_wb_cyc => i_wb_cyc,
      i_wb_dat(31 downto 0) => i_wb_dat(31 downto 0),
      i_wb_sel(3 downto 0) => i_wb_sel(3 downto 0),
      i_wb_sel_0_sp_1 => syscon_n_76,
      i_wb_sel_3_sp_1 => syscon_n_78,
      i_wb_stb => i_wb_stb,
      i_wb_we => i_wb_we,
      irq_gpio_enable_reg_0 => syscon_n_84,
      ...
      \irq_timer_cnt_reg[3]_0\ => syscon_n_83,
      ...
      o_wb_ack_reg_1 => syscon_n_77,
      o_wb_rdt(31 downto 0) => o_wb_rdt(31 downto 0),
      p_2_in(1 downto 0) => p_2_in(1 downto 0),
      ptc_irq => ptc_irq,
      ptc_irq_0 => syscon_n_82,
...
entity BD_syscon_wrapper_0_0 is
  ...
  attribute X_CORE_INFO of BD_syscon_wrapper_0_0 : entity is "syscon_wrapper,Vivado 2025.2";
...
architecture STRUCTURE of BD_syscon_wrapper_0_0 is
  ...
  attribute X_INTERFACE_MODE of gpio_irq : signal is "slave";
  ...
  attribute X_INTERFACE_MODE of o_timer_irq : signal is "master";
  ...
  attribute X_INTERFACE_MODE of ptc_irq : signal is "slave";
...
begin
  ...
  AN(1) <= \<const0>\;
  AN(0) <= \<const0>\;
  Digits_Bits(6) <= \<const0>\;
  Digits_Bits(5) <= \<const0>\;
  Digits_Bits(4) <= \<const0>\;
  Digits_Bits(3) <= \<const0>\;
  Digits_Bits(2) <= \<const0>\;
  Digits_Bits(1) <= \<const0>\;
  Digits_Bits(0) <= \<const1>\;
