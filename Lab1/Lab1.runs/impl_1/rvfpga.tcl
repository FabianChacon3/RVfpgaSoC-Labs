...
namespace eval ::optrace {
  variable script "/home/fchacon/RVfpgaSoC/LabProjects/Lab1/Lab1.runs/impl_1/rvfpga.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/fchacon/RVfpgaSoC/LabProjects/Lab1/Lab1.runs/synth_1/rvfpga.dcp
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source /home/fchacon/RVfpgaSoC/Labs/LabResources/Lab1/script.tcl"
    source /home/fchacon/RVfpgaSoC/Labs/LabResources/Lab1/script.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script /home/fchacon/RVfpgaSoC/Labs/LabResources/Lab1/script.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script /home/fchacon/RVfpgaSoC/Labs/LabResources/Lab1/script.tcl failed"
    }
    return -code error
  }
