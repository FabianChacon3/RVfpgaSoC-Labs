...
HD_PWD='/home/gost/Desktop/Repositories/RVfpgaSoC-Labs/Lab1/Lab1.runs/BD_bidirec_0_14_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_bidirec_0_14.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_bidirec_0_14.tcl
